...
class NewsfeedPresenter: NewsfeedPresentationLogic {
    ...
    func presentData(response: Newsfeed.Model.Response.ResponseType) {
        ...
        case .presentNewsfeed(let feed, let revealdedPostIds):
            ...
            let newsfeedViewModel = NewsfeedViewModel.init(cells: cells, footerTitle: footerTitle)
            viewController?.displayData(viewModel: Newsfeed.Model.ViewModel.ViewModelData.displayNewsfeed(newsfeedViewModel: newsfeedViewModel))
    ...
    private func cellViewModel(from feedItem: FeedItem, profiles: [Profile], groups: [Group], revealdedPostIds: [Int]) -> NewsfeedViewModel.Cell {
